            ...
            {me ? (
              <div className="mt-6 space-y-4">
                ...
                <p className="text-muted">
                  לחיצה על "התחלת עריכה" פותחת את האתר במצב עריכה: כל טקסט וכל תמונה
                  מסומנים בקו מקווקו, ולחיצה עליהם פותחת עריכה. בסיום - "שמירה ופרסום"
                  בסרגל התחתון.
                </p>
                {/* מדליק את מצב העריכה לפני המעבר לאתר. בלי זה מי שכבר מחוברת
                    (בזכות "זכור אותי") מגיעה לאתר עם מצב עריכה כבוי, לוחצת על
                    תמונה, ומקבלת הגדלה במקום עריכה. */}
                <Link
                  to="/"
                  onClick={() => sessionStorage.setItem("rz-editing", "1")}
