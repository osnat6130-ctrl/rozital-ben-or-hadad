...
export type Service = {
   ...
   *  ביניהם, ומסגרת אחידה הייתה יוצרת פסים שחורים. */
  ...
  /** ‼️ מעביר את תמונת הרוחב מאזור "למי זה מתאים" לאזור הגלריה, אחרי
   *  הכותרת שלה. דגל בתוכן ולא תנאי על שם הדף, כדי שאפשר יהיה להחליט
   *  את זה לכל תחום בנפרד. כרגע דלוק בצרכים מיוחדים בלבד, לפי בקשת
   *  רוזיטל. */
  bannerImageInGallery?: boolean;
  spotlight?: ServiceSection & {
    images?: { src: string; alt: string }[];
    /** פלייר הפעילות. שדה נפרד מהגלריה: הוא מסמך, מוצג לפני ההמלצות,
     *  וסידור הגלריה מהפאנל לא אמור להזיז אותו */
